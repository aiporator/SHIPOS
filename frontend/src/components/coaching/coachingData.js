...
export const getCoachingPaths = (de, navigate, handleCheckout) => [
  { id: 'personal', icon: Star, gradient: 'from-[#BFFF00] to-[#9ACC00]', title: de ? '1:1 Coaching mit Wlad' : '1:1 Coaching with Wlad', subtitle: de ? 'Persönliche Transformation' : 'Personal transformation', description: de ? 'Nichts ersetzt einen echten Experten. Wlad Jachtchenko begleitet dich persönlich durch deine spezifischen Herausforderungen.' : 'Nothing replaces a real expert.', cta: de ? 'Strategiegespräch buchen' : 'Book Strategy Call', action: () => handleCheckout('accelerator'), badge: de ? 'PREMIUM' : 'PREMIUM', badgeColor: 'bg-[#7B3FE4]' },
];

export const getPremiumFeatures = (de) => de
  ? ['12 Wochen Intensiv-Coaching mit Wlad', 'Maßgeschneiderte Leadership-Strategie', 'Wöchentliche 1:1 Sessions (60 Min.)', 'Zugang zu allen Premium-KI-Features', 'Alle Frameworks aus Wlads Methodik', 'Prioritäts-Support & Accountability', 'Persönliche Advice Reports', 'Exklusiver Zugang zur Leader-Community']
...
export const getFaqs = (de) => de ? [
  { q: 'Was ist der Unterschied zwischen WladBot und dem persönlichen Coaching?', a: 'WladBot ist dein KI-Coach, der rund um die Uhr verfügbar ist und dir bei täglichen Führungsherausforderungen hilft. Das persönliche Coaching mit Wlad geht tiefer: maßgeschneiderte Strategien, Accountability und persönliche Begleitung durch komplexe Transformationen.' },
  { q: 'Was erhalte ich bei der kostenlosen Leadership-Diagnose?', a: 'Du erhältst einen detaillierten Report mit deinem 3-Layer Score (KI-Kompetenz, Boardroom-Rhetorik, Strategisches EQ), einer Analyse deiner 5+1 Führungsdimensionen, einem personalisierten 30-Tage-Aktionsplan und einer ROI-Prognose.' },
  { q: 'Wie funktioniert das Strategiegespräch?', a: 'Das 15-minütige Strategiegespräch ist kostenlos und unverbindlich. Wlad analysiert deine aktuelle Situation, identifiziert deine größten Hebel und zeigt dir, wie du in 90 Tagen messbare Ergebnisse erzielst.' },
  ...
  { q: 'What do I get with the free Leadership Diagnosis?', a: 'A detailed report with your 3-Layer Score, analysis of 5+1 leadership dimensions, a personalized 30-day action plan, and ROI forecast.' },
  { q: 'How does the Strategy Call work?', a: 'The 15-minute call is free with no obligation. Wlad analyzes your situation, identifies leverage points, and shows how to achieve measurable results in 90 days.' },
