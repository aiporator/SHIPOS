    ...
    <div className="upsell-border">
      <div className="p-4 flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-[10px] text-muted-foreground">{de ? 'Setze die Erkenntnisse mit Expertenbegleitung um — kostenloses Erstgespräch' : 'Implement insights with expert guidance — free first call'}</p>
        </div>
