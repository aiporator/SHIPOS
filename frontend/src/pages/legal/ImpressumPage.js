  ...
  return (
    <LegalLayout title="Impressum">
      ...
      <section>
        ...
        <p>Geschäftsführer: Wladislaw Jachtchenko</p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          (OS) bereit: <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer">
      ...
      <section>
        <h2>Bildquellen</h2>
        <p>Fotolia.de, Pixabay.com, Patrick Reymann und eigene Bilder.</p>
      </section>
