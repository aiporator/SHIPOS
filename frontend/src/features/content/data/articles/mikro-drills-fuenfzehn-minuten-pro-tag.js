export default {
  slug: 'mikro-drills-fuenfzehn-minuten-pro-tag',
  type: 'guide',
  status: 'published',
  title: 'Mikro-Drills: fünfzehn Minuten pro Tag.',
  description:
    'Wie eine fünfzehn-Minuten-Routine in deinen Kalender passt · auch ' +
    'in stressigen Wochen. Mit drei konkreten Slot-Optionen, dem typischen ' +
    'Wochenfluss und Anti-Patterns.',
  ...
  body: [
    ...
    { type: 'list', style: 'numbered', items: [
      ...
      '7 Min: einen deiner echten Cases im Format der Lektion bearbeiten. WladBot drillt mit.',
      '3 Min: Korrektur lesen, Lerning notieren.',
      '2 Min: Tomorrow-Anker schreiben · was machst du morgen anders.',
    ] },
    { type: 'framework', code: 'MIKRO', title: 'Fünfzehn Minuten', explanation: '3 Min Input · 7 Min Drill am eigenen Case · 3 Min Korrektur · 2 Min Tomorrow-Anker. Fester Slot, nicht "wann immer Zeit". Echter Case, nicht generisches Beispiel. Korrektur, nicht Selbst-Bewertung.' },
    { type: 'callout', tone: 'lime', text: 'Fünfzehn Minuten täglich über dreißig Tage sind 7,5 Stunden. Das reicht in unseren Daten konsistent für einen messbaren Reflex-Lift. Mehr als 30 Min pro Tag bringt im Mittel keinen zusätzlichen Effekt · nur mehr Müdigkeit.' },
