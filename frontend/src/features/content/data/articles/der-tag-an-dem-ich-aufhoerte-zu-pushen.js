export default {
  ...
  description:
    ...
    '5–10 Stunden pro Woche zurückgewann.',
  ...
  seo: {
    ...
    keywords: [
      ...
      'mikromanagement loswerden',
      'delegieren lernen führungskraft',
      'loslassen als führungskraft',
      'vertrauen ins team aufbauen',
      'aufgaben delegieren',
  ...
  body: [
    ...
    { type: 'heading', level: 2, text: 'Was Mikromanagement wirklich ist.' },
    { type: 'paragraph', text: 'Ich war 14 Jahre lang Mikromanager und habe es nicht gewusst. Ich hätte es niemals so genannt. Ich nannte es "qualitätssicherung", "ich will dass es gut wird", "ich habe ein Auge drauf". Aus Sicht meines Teams hieß das: "Wlad vertraut mir nicht." Niemand hat es so direkt gesagt. Aber die Signale waren da.' },
    { type: 'paragraph', text: 'Mikromanagement hat nichts mit der Häufigkeit deiner Kontrollen zu tun. Es hat zu tun mit der Ebene auf der du eingreifst. Wenn du den Stil korrigierst statt das Ergebnis, mikromanagest du. Wenn du den Weg vorgibst statt das Ziel, mikromanagest du. Wenn du Reviews machst die niemand angefordert hat, mikromanagest du.' },
    { type: 'paragraph', text: 'Und der teuerste Teil daran: du selbst denkst, du machst gute Arbeit. Du arbeitest 50 Stunden die Woche. Du bist müde. Du fragst dich warum deine Leute nicht selbständiger sind. Die Antwort: sie sind so selbständig wie du sie sein lässt. Wer alle zwei Tage gefragt wird, traut sich keine Entscheidung. Wer jede Mail vorab geprüft sieht, schreibt jede Mail wie für den Chef, nicht für den Kunden.' },
    ...
    { type: 'paragraph', text: 'Erstens: meine Wochenstunden gingen von 52 auf 41 zurück. Nicht weil ich faulenzte, sondern weil ich nicht mehr Mails reviewte die nicht meine waren. 11 Stunden zurück, jede Woche.' },
    { type: 'paragraph', text: 'Zweitens: in den 1:1s redeten die Leute anders. Sie kamen mit Vorschlägen, nicht mit Fragen. "Ich überlege X zu tun, was hältst du davon" statt "wie sollen wir das machen". Das ist der Wechsel vom Bittsteller zum Mitdenker. Den hatten meine Leute schon vorher in sich. Ich hatte ihn nur deaktiviert.' },
    { type: 'paragraph', text: 'Drittens: zwei Leute, die ich für mittelmäßig gehalten hatte, lieferten plötzlich Spitzenarbeit. Ich war nicht das Problem das ich gelöst hatte. Ich war das Problem das sie gehemmt hatte. Das war die unangenehmste Erkenntnis. Die wertvollste auch.' },

    { type: 'heading', level: 2, text: 'Warum es so schwer ist aufzuhören.' },
    ...
    { type: 'paragraph', text: 'Wenn am Ende der Woche etwas nicht perfekt ist: bleib drin. Frag in der Reflexion was die Person sich gewünscht hätte. Dann delegier nächste Woche die nächste Aufgabe. Und die danach. In sechs Wochen wirst du zehn Stunden weniger arbeiten und dein Team wird besser sein. Versprochen.' },
    { type: 'paragraph', text: 'Was du dafür aufgeben musst: das Gefühl, unentbehrlich zu sein. Das ist auch das Schöne daran. Wer unentbehrlich ist, fährt nie in Urlaub. Wer ein System gebaut hat, kann zwei Wochen ans Meer. Such dir aus was du lieber willst.' },
  ],
  related: [
