export default {
  slug: 'ki-tools-fuer-fuehrungskraefte-2026',
  type: 'guide',
  status: 'published',
  title: 'KI-Tools für Führungskräfte 2026.',
  description:
    'Welche fünf Tools sich für deinen Wochenfluss wirklich lohnen, welche ' +
    'drei du ignorieren kannst, und warum die Frage "welches Tool" weniger ' +
    'wichtig ist als "welche Methodik".',
  ...
  body: [
    ...
    { type: 'paragraph', text: 'Wer noch händisch in Meetings tippt, verliert zwei Stunden pro Woche. Fathom transkribiert + summarisiert + extrahiert Action Items. Otter ist die etabliertere Variante. Beide gut.' },
    { type: 'heading', level: 2, text: '05. Granola für 1:1-Vorbereitung.' },
    { type: 'paragraph', text: 'Granola erstellt vor jedem 1:1 eine Briefing-Notiz aus deiner Historie mit der Person. Spart fünf Minuten pro 1:1, summiert über zwanzig 1:1s pro Woche zu fast zwei Stunden gewonnener Vorbereitungszeit.' },
    { type: 'heading', level: 2, text: 'Drei Tools die du ignorieren kannst.' },
    { type: 'list', style: 'bullet', items: [
      'KI-Slack-Bots die "Engagement scoren". Datenpunkte ohne Aussagekraft, hohe Datenschutz-Risiken.',
      'KI-Personas für Manager-Training. Sie klingen wie Bots, der echte Mitarbeiter merkt es.',
      'KI-generierte LinkedIn-Posts. Klingen wie alle anderen KI-LinkedIn-Posts. Wenn du nichts zu sagen hast, sag nichts.',
    ] },
