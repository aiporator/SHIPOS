...
export default {
  ...
  description:
    'Definition, die vier Dimensionen (4 I) und der Unterschied zur ' +
    'transaktionalen Führung. Wie transformationale Führung im Alltag ' +
  ...
  seo: {
    ...
    description:
      ...
      'Stimulation, individuelle Wertschätzung), Unterschied zur transaktionalen ' +
      'Führung und konkrete Anwendung. Von Wlad Jachtchenko, 3× SPIEGEL-Bestseller.',
    keywords: [
      ...
      'vier Dimensionen transformationale Führung',
      'Führungsstile',
  ...
  body: [
    ...
    { type: 'heading', level: 2, text: 'Die vier Dimensionen der transformationalen Führung.' },
    { type: 'paragraph', text:
    ...
    { type: 'callout', tone: 'lime', text:
      'Merkhilfe: die vier I. Idealisierter Einfluss · Inspirierende Motivation · Intellektuelle Stimulation · Individuelle Wertschätzung. Wer alle vier ausfüllt, führt transformational.' },
    { type: 'heading', level: 2, text: 'Transformationale vs. transaktionale Führung.' },
    { type: 'paragraph', text:
    ...
    { type: 'heading', level: 2, text: 'Wie sieht transformationale Führung im Alltag aus?' },
    { type: 'paragraph', text:
