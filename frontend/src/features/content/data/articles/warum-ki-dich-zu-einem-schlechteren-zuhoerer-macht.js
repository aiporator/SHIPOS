export default {
  ...
  body: [
    ...
    { type: 'heading', level: 2, text: 'Gegensteuern, ohne KI zu verbannen.' },
    { type: 'paragraph', text: 'Die Antwort ist nicht, alle Tools abzuschaffen · das wäre naiv und würde echte Effizienzgewinne verschenken. Die Antwort ist eine klare Aufgabenteilung: KI übernimmt Stufe 1 bis 3, du trainierst bewusst Stufe 4 aufwärts.' },
  ...
  seo: {
    ...
    description: 'KI übernimmt Transkription und Antwortvorschläge – und schwächt dabei deine eigene Zuhör-Fähigkeit. Der Zusammenhang mit den 10 Stufen des Zuhörens, plus konkrete Gegenmaßnahmen.',
    keywords: ['ki und zuhören', 'ki macht schlechter zuhörer', 'aktives zuhören ki zeitalter', '10 stufen des zuhörens ki', 'meeting transkription nachteile'],
  },
  related: ['die-10-stufen-des-zuhoerens-wlads-modell-erklaert', 'zehn-stufen-des-zuhoerens'],
};
