export default {
  ...
  body: [
    ...
    { type: 'heading', level: 2, text: 'Pfad 01: Der 30-Tage-Sprint (Eingang).' },
    ...
    { type: 'list', style: 'bullet', items: [
      'Skill-Lücke schließen: Sprint allein reicht.',
      'Skill-Lücke + Identitäts-Begleitung: Plus-Plus.',
      'Spezifische Sub-Skill (z.B. Investor-Pitch): Sprint + ein Spezial-Kurs.',
      'Team-Mehrheit aufbauen: Team-Rollout mit Sprint-Kohorten.',
    ...
    { type: 'callout', tone: 'lime', text: 'Mehr als eine Transformation: LeaderOS ist eine kontinuierliche Lern-Architektur. Du startest mit Sprint, du verlässt sie nie · du bewegst dich nur in die Pfade die zu deinem Quartal passen.' },
  ...
  seo: {
    ...
    description: 'Die LeaderOS Kurs-Architektur: Sprint, Plus-Plus, Spezial-Kurse, Team-Rollout, Mentoring. Fünf Lern-Pfade mit klarem Ziel. Von Wlad Jachtchenko.',
