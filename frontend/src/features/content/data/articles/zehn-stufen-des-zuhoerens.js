export default {
  ...
  description:
    'Vom abwesenden Hören bis zum transformativen Zuhören. Wo du auf der ' +
    'Skala stehst, woran du es erkennst und wie du eine Stufe pro Woche ' +
    'aufsteigst.',
  ...
  body: [
    ...
    { type: 'list', style: 'numbered', items: [
      ...
      'Stufe 2: So tun als ob. Du nickst aber denkst an etwas anderes.',
      'Stufe 3: Selektiv hören. Du wartest auf das Stichwort wo du selbst weitersprechen kannst.',
    ] },
    { type: 'paragraph', text: 'Wenn du am Ende eines 1:1 nicht zusammenfassen könntest was das Gegenüber wollte, warst du auf Stufe 1-3.' },
    { type: 'heading', level: 2, text: 'Stufen 04-06: das aufmerksame Zuhören.' },
    { type: 'list', style: 'numbered', items: [
      'Stufe 4: Aufmerksam hören. Du verstehst was gesagt wurde, beantwortest auf Sachebene.',
      'Stufe 5: Aktives Zuhören. Du paraphrasierst: "wenn ich dich richtig verstehe, sagst du..."',
      'Stufe 6: Klärendes Zuhören. Du fragst nach, statt zu antworten: "was meinst du mit X?"',
    ] },
    { type: 'paragraph', text: 'Stufe 4 bis 6 ist guter Manager-Standard. Die meisten erreichen sie nach drei Jahren Erfahrung. Hier ist die meisten Coaching-Programme zu Ende.' },
    { type: 'heading', level: 2, text: 'Stufen 07-10: das tiefe Zuhören.' },
    { type: 'list', style: 'numbered', items: [
      'Stufe 7: Empathisches Zuhören. Du hörst die Schulz-von-Thun-Selbstoffenbarung. "Du sagst X, klingt als ob dich Y belastet."',
      'Stufe 8: Generatives Zuhören. Du hilfst dem Sender klarer zu denken. "Wenn ich diese drei Sachen verbinde, sagst du eigentlich Z."',
      'Stufe 9: Stilles Zuhören. Du sagst nichts. Du hältst Raum. Manche Probleme lösen sich im Schweigen.',
      'Stufe 10: Transformatives Zuhören. Das Gegenüber geht aus dem Gespräch mit einer neuen Frage, die du nicht gestellt hast.',
    ] },
