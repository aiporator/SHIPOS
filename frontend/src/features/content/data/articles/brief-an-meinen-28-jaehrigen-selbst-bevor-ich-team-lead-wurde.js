export default {
  ...
  description:
    ...
    'ein Jahr kosten. Ein Brief an mein jüngeres Ich.',
  ...
  seo: {
    ...
    keywords: [
      ...
      'erste führungsposition tipps',
      'zum ersten mal teamlead',
      'team lead werden',
      'neuer chef tipps',
  ...
  body: [
    { type: 'paragraph', text: 'Lieber Wlad. Du bist 28. Heute hat dich Andreas in sein Büro geholt und gesagt: "Du übernimmst das Team ab dem ersten." Du hast genickt. Du hast gelächelt. Du bist rausgegangen, hast die Tür hinter dir zugezogen, und auf dem Flur kam dieser eine Gedanke: ich habe keine Ahnung was ich da tue.' },
    { type: 'paragraph', text: 'Du wirst die nächsten sechs Monate kaum schlafen. Du wirst um 23 Uhr noch Slack lesen. Du wirst Sonntagabends ein Gedankenkarussell haben das sich um drei Mitarbeiter dreht. Du wirst denken, du musst es allen zeigen. Du wirst pushen. Du wirst kontrollieren. Du wirst Überstunden machen die dich nichts bringen.' },
    { type: 'paragraph', text: 'Ich schreibe dir das hier nicht, damit du es vermeidest. Du wirst es trotzdem machen. Ich schreibe dir das hier, damit du es schneller hinter dich bringst. Damit du in Monat drei merkst, was du in Monat zwölf sowieso lernst. Das ist alles was ein guter Brief leisten kann.' },
    ...
    { type: 'paragraph', text: 'Und auf dem Rückweg zum Schreibtisch wirst du merken: das hat zehn Minuten gedauert, hat nicht weh getan, und Tim hat es respektiert. Das ist der Moment in dem du Führungskraft wirst. Nicht beim Titel. Nicht beim Gehalt. In diesem Gespräch. In sechs Monaten.' },
    { type: 'paragraph', text: 'Bis dahin: trink mehr Wasser, schreib weniger Sonntagabend-Slacks, und ruf deine Mutter an. Gruß, Wlad (mit 17 Jahren mehr).' },
  ],
  related: [
