export default {
  ...
  body: [
    ...
    { type: 'paragraph', text: 'Für Mittelständler ohne eigenes L&D-Team ist genau das der Punkt, an dem Leader-OS ansetzt: ein fertiges Curriculum statt eines leeren Blattes. Der 30-Tage-Sprint deckt die drei priorisierten Module – Feedback, Delegation, Kommunikation – strukturiert ab, WladBot begleitet jede Führungskraft einzeln, und HR muss weder Trainer suchen noch Termine koordinieren, um trotzdem allen zwanzig Führungskräften ein echtes Curriculum zu geben.' },
  ],
  seo: {
    title: 'Führungskräfte-Curriculum im Mittelstand aufbauen · Leader-OS',
