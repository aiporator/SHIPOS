export default {
  slug: 'leader-os-fuer-neu-befoerderte-leads',
  type: 'guide',
  status: 'published',
  title: 'Leader-OS für neu beförderte Leads.',
  description:
  ...
  cover: null,
  tags: ['Leader-OS', 'Onboarding', 'Karriere'],
  body: [
    { type: 'paragraph', text: 'Die ersten 90 Tage nach einer Beförderung entscheiden ob du langfristig in der Rolle ankommst. Drei Studien aus DACH-Personalberatungen zeigen das gleiche Muster: wer die ersten 30 Tage strukturiert angeht, hat 70 Prozent höhere 2-Jahres-Retention.' },
    ...
    { type: 'paragraph', text: 'Tag 1-10: Diagnose. Drei 1:1s mit jedem direct report, ein Team-Stand-up als Beobachter, drei strategische Gespräche mit deinem eigenen Manager. Keine Entscheidungen. Notizen.' },
    { type: 'paragraph', text: 'Tag 11-30: Stabilisierung. Drei Mini-Verbesserungen ankündigen (zB Stand-up-Format, 1:1-Rhythmus, Slack-Kanal-Cleanup). Nichts Großes. Du signalisierst "ich greife ein und ich höre zu".' },
