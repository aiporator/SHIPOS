...
export default {
  ...
  type: 'guide',
  status: 'published',
  title: 'Leader-OS vs klassisches Coaching.',
  description:
    'Drei Stellen wo Leader-OS gewinnt. Eine Stelle wo Coaching gewinnt. ' +
  ...
  body: [
    ...
    { type: 'paragraph', text:
      ...
      'Leader-OS: 24/7-Zugang zu WladBot, drei bis fünf Minuten Antwortzeit, Sprint-Plan im Hintergrund. Wenn ' +
      'du Dienstagabend 22:47 Uhr eine Skript-Korrektur brauchst, gewinnt Leader-OS klar.' },
    ...
    { type: 'paragraph', text:
      ...
      'aus drei Schulen, mit Lieblings-Frameworks die NICHT zu deinem konkreten Fall passen. Leader-OS: eine ' +
    ...
    { type: 'callout', tone: 'lime', text:
      ...
      'für die methodische Tiefe und für die tägliche Skill-Wiederholung gewinnt Leader-OS. Punkt.' },
    ...
    { type: 'paragraph', text:
      'Genau deshalb gibt es Plus-Plus: 12 Monate Drill via Leader-OS PLUS Live-Sessions mit Wlad persönlich. ' +
    ...
    { type: 'framework', code: 'COMBO', title: 'Die ehrliche Antwort',
      explanation:
        'Pure Skill-Wiederholung und methodische Konsistenz: Leader-OS allein. Identitäts-Arbeit über ' +
