...
export default {
  ...
  body: [
    ...
    { type: 'paragraph', text:
      'Leader-OS ist kein Kurs. Es ist ein Operating System für Führungskräfte. Drei Schichten greifen ineinander: ' +
    ...
    { type: 'heading', level: 2, text: 'Was Leader-OS nicht ist.' },
