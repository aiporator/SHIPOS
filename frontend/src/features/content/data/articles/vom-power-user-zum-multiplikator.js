export default {
  slug: 'vom-power-user-zum-multiplikator',
  type: 'guide',
  status: 'published',
  title: 'Vom Power-User zum Multiplikator.',
  description:
    'Wenn du KI gut nutzt und dein Team nicht: drei konkrete Hebel um ' +
    'deinen Einzel-Erfolg in einen Team-Effekt zu verwandeln, ohne als ' +
    'KI-Evangelist zu wirken.',
