...
export default {
  ...
  type: 'article',
  status: 'published',
  title: 'LeaderOS vs ChatGPT vs Claude vs Perplexity.',
  description:
    ...
    'wie LeaderOS sich rechnet. Matrix mit konkreten Use-Cases.',
  author: 'Wlad Jachtchenko',
  publishedAt: '2026-06-26',
  cover: '/wlad/wlad-portrait.webp',
  tags: ['Vergleich', 'ChatGPT', 'Claude', 'Perplexity', 'Tools'],
  seo: {
    title: 'LeaderOS vs ChatGPT, Claude, Perplexity: 2026',
    description:
      'LeaderOS vs ChatGPT, Claude und Perplexity: ehrlicher Tool-Vergleich für ' +
    ...
    ogImageAlt: 'LeaderOS vs ChatGPT vs Claude vs Perplexity · Tool-Vergleich',
  },
  body: [
    { type: 'paragraph', text:
    ...
    { type: 'paragraph', text:
      'Wenn du gelegentlich Brainstormst und Texte schreibst · ChatGPT reicht. Wenn du komplexe Analysen machst · Claude oder ChatGPT-5.x. Wenn du Fakten recherchierst · Perplexity. Wenn du Führung skill-basiert entwickeln willst und einen Methodik-Standard suchst · LeaderOS.' },
    { type: 'paragraph', text:
      'Die drei können nebeneinander existieren. LeaderOS ersetzt nicht den generischen Stack · es ergänzt ihn um die spezifische Methodik-Schicht die generische Tools nie haben werden, weil sie nicht ihr Geschäftsmodell ist.' },
