export default {
  ...
  body: [
    ...
    { type: 'callout', tone: 'lime', text: 'Werde Teil von LeaderOS · 6 Monate strukturierte Ausbildung, alle Vorteile ab Tag 1, Lifetime-Zugang. 14 Tage kostenlos, ohne Karte: leader-os.de/#klassen' },
  ],
  seo: {
