export default {
  slug: 'system-statt-transformation-der-kleine-hebel',
  type: 'article',
  status: 'published',
  ...
  body: [
    ...
    { type: 'paragraph', text: 'Tobias (Senior Engineering Manager, anonymisiert) entschied dass er sein tägliches Stand-up nicht mehr mit "wie geht es uns" eröffnet, sondern mit einem konkreten Daten-Snippet. Eine Mikro-Änderung. Drei Monate später: Sprint-Velocity um 18 Prozent gestiegen. Nicht weil der Daten-Snippet die Velocity steigert · sondern weil die Stand-ups jetzt fokussierter laufen.' },
    { type: 'heading', level: 2, text: 'Beispiel 02: Donnerstag-Streich-Ritual.' },
    { type: 'paragraph', text: 'Sandra (VP Operations) hat sich jeden Donnerstagmorgen 20 Minuten reserviert um drei Aufgaben aus ihrer Wochenplanung explizit zu streichen. Sechs Monate später: zehn Stunden Deep-Work pro Woche gewonnen, drei strategische Initiativen erfolgreich geliefert.' },
    { type: 'heading', level: 2, text: 'Beispiel 03: Freitag-Reflexions-Notiz.' },
    { type: 'paragraph', text: 'Stefan (CTO Scaleup) schreibt jeden Freitag drei Sätze zu seiner Woche. Was lief gut, was lief schlecht, was probiert er nächste Woche anders. Zwölf Wochen später: er kann pro Quartal vier konkrete Skill-Verbesserungen benennen. Niemand hat ihn dazu gezwungen · drei Sätze pro Woche.' },
