...
const WEBINAR_ANGLES = [
  // ── D03 · Das Angebot selbst · Quadrant: convert ──────────────────
  {
    ...
    bottomText: 'DO 17.09. · 10:00 UHR · 90 MIN · 0 €',
    cta: 'PLATZ SICHERN',
  ...
  // ── B01 · Der Seminar-Schmerz · Quadrant: educate → convert ───────
  {
    ...
    bottomText: 'TRAINIEREN STATT WISSEN · 17.09. LIVE',
    cta: 'LIVE DABEI',
    landing: 'https://leader-os.de/webinar',
  ...
  // ── A02 · Feedbackformel · Quadrant: educate ──────────────────────
  {
    ...
    bottomText: 'FEEDBACKFORMEL · LIVE AM 17.09.',
    cta: 'LIVE DABEI',
    landing: 'https://leader-os.de/webinar',
  ...
  // ── A01 · SEXIER · Quadrant: educate ──────────────────────────────
  {
    ...
    titleText: 'STATEMENT.\nEXPLANATION.\nEXAMPLE.',
    bottomText: 'SEXIER-MODELL · LIVE AM 17.09.',
    cta: 'LIVE DABEI',
    landing: 'https://leader-os.de/webinar',
  ...
  // ── C02 · 400.000+ seit 2007 · Quadrant: convert ──────────────────
  {
    ...
    bottomText: 'DO 17.09. · 10:00 UHR · KOSTENLOS',
    cta: 'PLATZ SICHERN',
    landing: 'https://leader-os.de/webinar',
  ...
  // ── C01 · 3× SPIEGEL · Quadrant: convert ──────────────────────────
  {
    ...
    bottomText: 'WLAD JACHTCHENKO · 17.09. · 10:00 UHR',
    cta: 'PLATZ SICHERN',
    landing: 'https://leader-os.de/webinar',
  ...
  // ── D01 · Leader-Check · Quadrant: educate/no budget → organic-first ─
  {
    ...
    bottomText: 'LEADER-CHECK · KI · RHETORIK · EQ',
    cta: 'CHECK STARTEN',
  ...
  // ── D02 · 30-Tage-Challenge · Quadrant: convert (Warm) ────────────
  {
    ...
    titleText: 'TÄGLICH.\n15 MINUTEN.',
    bottomText: '30-TAGE-CHALLENGE · 14 TAGE KOSTENLOS',
    cta: 'LEADER-OS.DE',
